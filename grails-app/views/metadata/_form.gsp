...
<tr class="prop">
    <td valign="top" class="name"><label><g:message
            code="config.dateCreated.label" default="Data Created"/></label>
    </td>
    <td valign="top" class="value">
...
<tr class="prop">
    <td valign="top" class="name"><label><g:message
            code="config.lastUpdated.label" default="Last Updated"/></label>
    </td>
    <td valign="top" class="value">
...
<tr class="prop">
    ...
    <td valign="top" class="value">
        <g:formatDate date="${metadataInstance?.collectionPeriodFrom}"/> to <g:formatDate
                date="${metadataInstance?.collectionPeriodTo}"/>
    </td>
</tr>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:checkBox name="studentOwned" value="${metadataInstance?.studentOwned}"
                    onClick="toggleStudentDataOwner(this);"/>
