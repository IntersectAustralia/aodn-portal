...
class MetadataService {
	...
	public void createColletionDescriptionRecord(Metadata metadata) {
	...
	public void createCompliantPartyRecords(Metadata metadata) {
	...
	private File getCsvFile() {
		def datasetFile = getSession().getAttribute('datasetFile')
